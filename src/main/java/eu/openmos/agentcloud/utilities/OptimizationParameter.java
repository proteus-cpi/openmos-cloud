...
public class OptimizationParameter {
    ...
    public String toString() {
        return name + eu.openmos.model.utilities.SerializationConstants.TOKEN_OPTIMIZATION_PARAMETER + type + eu.openmos.model.utilities.SerializationConstants.TOKEN_OPTIMIZATION_PARAMETER + unit + eu.openmos.model.utilities.SerializationConstants.TOKEN_OPTIMIZATION_PARAMETER + value + eu.openmos.model.utilities.SerializationConstants.TOKEN_OPTIMIZATION_PARAMETER + defaultValue;
    }
    ...
    public static OptimizationParameter fromString(String object) {
        StringTokenizer tokenizer = new StringTokenizer(object, eu.openmos.model.utilities.SerializationConstants.TOKEN_OPTIMIZATION_PARAMETER);
