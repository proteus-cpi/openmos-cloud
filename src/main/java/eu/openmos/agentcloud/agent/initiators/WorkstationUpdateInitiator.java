 ...
 * Ontology: ONTO_WORKSTATION_UPDATE.
 * 
 * @author Valerio Gentile <valerio.gentile@we-plus.eu>
 * @author Pedro Monteiro <pedro.monteiro@uninova.pt>
 * 
 */
public class WorkstationUpdateInitiator extends AchieveREInitiator {
    /**
    * Object that writes logs into the file.
    */
    private static final Logger logger = Logger.getLogger(WorkstationUpdateInitiator.class);   
    ...
    public static ACLMessage buildMessage(Agent agent, SubSystem subSystem) {
        ...
        msg.setOntology(Constants.ONTO_WORKSTATION_UPDATE);
        try {
     ...
     */
    public WorkstationUpdateInitiator(Agent a, ACLMessage msg) {
        super(a, msg);
    }
    ...
    protected void handleInform(ACLMessage inform) {
        logger.info("Optimizer acknowledged new workstation update message from agent " + myAgent.getLocalName() + ".");
    }
