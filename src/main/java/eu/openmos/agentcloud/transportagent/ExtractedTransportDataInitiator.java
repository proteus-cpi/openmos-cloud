 ...
 * 
 */
public class ExtractedTransportDataInitiator extends AchieveREInitiator {
    /**
    * Object that writes logs into the file.
    */
    private static final Logger logger = Logger.getLogger(ExtractedTransportDataInitiator.class.getName()); 
...
//    }
     ...
     */
    public ExtractedTransportDataInitiator(Agent a, ACLMessage msg) {
        super(a, msg);
    }
