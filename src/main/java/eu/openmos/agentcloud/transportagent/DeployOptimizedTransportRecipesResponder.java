 ...
 * 
 */
public class DeployOptimizedTransportRecipesResponder extends AchieveREResponder {
    /**
    * Object that writes logs into the file.
    */
    private static final Logger logger = Logger.getLogger(DeployOptimizedTransportRecipesResponder.class.getName());    
     ...
     * listen to.
     */
    public DeployOptimizedTransportRecipesResponder(Agent a, MessageTemplate mt) {
        super(a, mt);
    }
    ...
    protected ACLMessage handleRequest(ACLMessage request) throws NotUnderstoodException, RefuseException {
        ...
        if(!recipeDeployed){
            ...
            ((TransportAgent) myAgent).deployedRecipes.addAll(optimizedRecipes);
