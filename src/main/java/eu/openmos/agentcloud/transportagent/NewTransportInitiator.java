...
/**
 * Notifies the optimizer of a new transport agent in the system.
 * 
 ...
 */
public class NewTransportInitiator extends AchieveREInitiator {
    /**
    * Object that writes logs into the file.
    */
    private static final Logger logger = Logger.getLogger(NewTransportInitiator.class);      
    /**
...
*/    
     ...
     */
    public NewTransportInitiator(Agent a, ACLMessage msg) {
        super(a, msg);
        this.msg = msg;
    }
    ...
    protected void handleFailure(ACLMessage failure) {
        ...
        ((TransportAgent) myAgent).addBehaviour(new NewTransportInitiator(myAgent, this.msg));
    }
}
