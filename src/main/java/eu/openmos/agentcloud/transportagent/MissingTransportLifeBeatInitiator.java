 ...
 * 
 */
public class MissingTransportLifeBeatInitiator extends AchieveREInitiator {
    /**
    * Object that writes logs into the file.
    */
    private static final Logger logger = Logger.getLogger(MissingTransportLifeBeatInitiator.class);   
     ...
     */
    public MissingTransportLifeBeatInitiator(Agent a, ACLMessage msg) {
        super(a, msg);
    }
    ...
    protected void handleInform(ACLMessage inform) {
        logger.info("Optimizer acknowledged new missing life beat from transport " + myAgent.getLocalName() + ".");
    }
