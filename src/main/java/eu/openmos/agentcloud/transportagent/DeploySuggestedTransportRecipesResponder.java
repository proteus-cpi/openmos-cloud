 ...
 */
public class DeploySuggestedTransportRecipesResponder extends AchieveREResponder {
    /**
    * Object that writes logs into the file.
    */
    private static final Logger logger = Logger.getLogger(DeploySuggestedTransportRecipesResponder.class.getName());   
     ...
     * listen to.
     */
    public DeploySuggestedTransportRecipesResponder(Agent a, MessageTemplate mt) {
        super(a, mt);
    }
