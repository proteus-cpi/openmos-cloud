...
public class RecipeExecutionDataFilter implements Serializable
{
    ...
    private boolean alsoTriggerData = false;
    ...
    public String toString() {
        return "RecipeExecutionDataFilter{" + 
                ...
                ", kpiSettingName=" + kpiSettingName + 
                ", alsoTriggerData=" + alsoTriggerData + 
    ...
    public void setAlsoTriggerData(boolean alsoTriggerData) {
        this.alsoTriggerData = alsoTriggerData;
    }
