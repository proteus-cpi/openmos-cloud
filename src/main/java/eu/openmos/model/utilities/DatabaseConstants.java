...
//    public final static String SSTYPE = "ssType";
    ...
    public final static String SKILLTYPE_ATOMIC = "skillTypeAtomic";
    public final static String SKILLTYPE_COMPOSITE = "skillTypeAtomic";
    
//    public final static String SKILLTYPE_ATOMIC = "ATOMIC";
//    public final static String SKILLTYPE_COMPOSITE = "COMPOSITE";

    public final static String USER_NAME = "userName";
    public final static String SYSTEM_STAGE = "systemStage";
    ...
    public final static String PHYSICAL_ADJUSTMENT_TYPE = "physicalAdjustmentType";
    public final static String SUBSYSTEM_ID = "subSystemId";
    public final static String SUBSYSTEM_STAGE = "subSystemStage";
}
